...
export const gridItems = [
{
  ...
  {
    id: 4,
    title: "Tech enthusiast with a passion for User centered Design.",
    description: "",
...
export const testimonials = [
  {
    ...
    title: "Head of Education at A2SV",
    thumbnail: "/gragn.jpeg",
  },
  {
    quote:
      "Working with Yosef has been an incredible experience. He is not only highly skilled as a developer but also consistently demonstrates strong problem-solving abilities and an unmatched work ethic. His passion for what he does is evident in every project we collaborate on, and his contributions always elevate the team's output. I truly appreciate the opportunity to work alongside someone as talented and driven as Yosef.",
...
export const workExperience = [
  {
    id: 1,
    title: "UI Designer and Front-End Developer @ Africa to Silicon Valley (A2SV) – 2023",
    desc: "Worked on UI design and development projects, connecting African talents with tech companies using React, Next.js, and TailwindCSS for intuitive user interfaces.",
  ...
  {
    id: 4,
    title: "UI Designer @ Software Department, AASTU – 2022",
    desc: "Led a 7-member design team in crafting a website for the software engineering department, creating wireframes and prototypes in Figma.",
    className: "md:col-span-2",
    thumbnail: "/exp4.svg",
  },
];
